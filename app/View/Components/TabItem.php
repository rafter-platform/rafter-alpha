...
class TabItem extends Component
{
    ...
    {
        if ($this->isActive()) {
            return "whitespace-no-wrap mr-8 py-4 px-1 border-b-2 border-indigo-500 font-medium text-sm leading-5 text-indigo-600 hover:text-indigo-800 focus:outline-none focus:text-indigo-800 focus:border-indigo-700";
        }
